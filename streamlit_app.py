...
# Title
st.title("🦉 Owl Movement Classifier — RAG + SHAP + LLM")
...
def shap_text_summary(row, shap_vals):
    ...
    for feat, val in pairs_sorted:
        ...
        explanation += f"- {feat}: {val:.3f} → {direction}\n"
    return explanation
...
page = st.sidebar.radio(
    "Navigation",
    ["🏠 Home", "🔍 Prediction Explorer", "📈 SHAP Explainability", "🧠 RAG Movement Explanation", "💬 Owl Chatbot", "📘 Documentation"]
)
...
# =========================================================
#      PAGE 2 — PREDICTION + SHAP LOCAL EXPLAINABILITY
# =========================================================
...
# =========================================================
    ...
    st.header("📈 Global SHAP Interpretability")
...
# =========================================================
#           PAGE 4 — RAG + LLM MOVEMENT EXPLANATION
# =========================================================
elif page == "🧠 RAG Movement Explanation":

    st.header("🧠 Movement Explanation (RAG + LLM)")
...
# =========================================================
#             PAGE 5 — OWL CHATBOT (RAG)
# =========================================================
elif page == "💬 Owl Chatbot":

    st.header("💬 Owl Chatbot (RAG-enabled)")
